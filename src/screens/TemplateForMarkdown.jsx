...
import MarkdownDisplay from '../forDelete/MarkdownDisplay';
      ...
      <View style={styles.tabsContainer}>
        <Pressable
          ...
          style={[
            styles.tab,
            {
              backgroundColor: tab === 'edit' ? 'black' : null,
            },
          ]}>
          <Text
            style={[
        ...
        <Pressable
          ...
          style={[
            styles.tab,
            {backgroundColor: tab === 'preview' ? 'black' : null},
          ]}>
          <Text
            style={[
              styles.tabText,
              {
                color: tab === 'preview' ? 'white' : 'black',
              },
            ]}>
            Preview
          </Text>
...
export default TemplateForMarkdown;
